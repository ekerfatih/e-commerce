...
const ShopHeader = () => {
    return (<section className="h-full">
        <div
            className="shop-header w-11/12 mx-auto flex flex-col sm:flex-row items-center justify-between sm:pl-rounded-[5px] overflow-visible h-full sm:h-11/12">
            <div
                className="font-montserrat sm:basis-0 sm:grow-1 flex flex-col items-center sm:items-start text-center sm:text-left sm:w-7/12 px-4 py-12 sm:pl-22">
            ...
            <div
                className=" flex sm:translate-x-15 justify-center h-full basis-0 sm:grow-[1.1] sm:justify-end z-[1]">
                <img
                    src="/pose/girl.png"
                    alt=""
